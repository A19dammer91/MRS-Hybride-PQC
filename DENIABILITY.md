...
N = 366
│
├── (A=0,  B=40.67)   ← invalid (B not integer)
├── (A=9,  B=19)      ← valid ✓
├── (A=18, B=0)       ← valid ✓  (but B=0 is edge case)
├── (A=27, B=-19)     ← invalid (B negative)
└── ...
```
...
For `N = 366`: `A₀ = 366 mod 9 = 6`, so `R(366) = floor((366 - 114) / 171) + 1 = 2` valid representations.
