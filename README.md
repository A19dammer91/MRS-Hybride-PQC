...
> *Reconstructs the exact (a, b) pair for the current Matryoshka layer in O(1) without enumeration. For the 3-layer `sample_three_layers` engine this loop repeats with N ← a until depth is reached.*
